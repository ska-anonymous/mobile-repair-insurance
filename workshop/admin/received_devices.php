                    ...
                    <div class="card-body" style="overflow-x: auto;">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT rc.id, rc.description, rc.damaged_parts, rc.estimated_price, i.name, i.address, i.country, i.city, i.postal_code, i.email, i.phone
                                FROM
                                    repair_cases rc
                                JOIN
                                    ...
                                    foreach ($data as $row) {
                                        echo '
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-success" href="review_device.php?id=' . $row['id'] . '">
                                                        Review Device
                                                    </a>
                                                </td>
                                            </tr>
