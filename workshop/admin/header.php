...
if (!$_SESSION['logged'] || $_SESSION['user']['role'] != 'admin' || $_SESSION['user']['type'] != 'workshop') {
...
<?php
    // now check whether this insurance company is approved or not
    require('../../common/config/db_connect.php');

    $insurance_id = $_SESSION['user']['business_id'];
    $sql = "SELECT status from workshops WHERE id='$insurance_id'";
    ...
    if($status == 'awaiting'){
        $_SESSION['blocked']['cause'] = 'awaiting';
        $_SESSION['blocked']['message'] = 'This account is not yet approved by ADMIN. You will be notified when it is approved';
        header('location:../../login');
        exit(0);
    }
    if($status == 'rejected'){
        $_SESSION['blocked']['cause'] = 'rejected';
        $_SESSION['blocked']['message'] = 'This account is rejected by ADMIN. You will not be able to login';
        header('location:../../login');
        exit(0);
    }
?>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown user-menu">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                        <img src="../../common/dist/img/user2-160x160.jpg" class="user-image img-circle elevation-2"
                            alt="User Image">
                ...
                <!-- Theme toggler -->
                <li class="nav-item">
                    <a href="#" class="nav-link" role="button" id="theme-toggler" onclick="toggleTheme()"
                        data-theme="light">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar mt-2">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="new_cases.php" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="rejected_cases.php" class="nav-link">
                                <i class="nav-icon bi bi-trash3"></i>
                                <p>
                                    Rejected Repair Cases
                                </p>
                            </a>
                        </li>                      
                        <li class="nav-item">
                            <a href="approved_cases.php" class="nav-link">
                                <i class="nav-icon bi bi-check2-all"></i>
                                <p>
                                    Approved Repair Cases
                                </p>
                            </a>
                        </li>                      
                        <li class="nav-item">
                            <a href="received_devices.php" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="reviewed_devices.php" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="completed_cases.php" class="nav-link">
