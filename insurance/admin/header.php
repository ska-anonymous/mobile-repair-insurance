...
if (!$_SESSION['logged'] || $_SESSION['user']['role'] != 'admin' || $_SESSION['user']['type'] != 'insurance') {
...
$sql = "SELECT status from insurances WHERE id='$insurance_id'";
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar mt-2">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="register_customers.php" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="repair_registration.php" class="nav-link">
