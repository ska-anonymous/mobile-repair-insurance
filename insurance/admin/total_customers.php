...
<head>
  ...
  $sql = "SELECT * FROM customers WHERE insurance_id='$insurance_id'";
                ...
                foreach ($customers as $row) {
                  echo '
                      <tr>
                        ...
                        <td>
                            <a href="edit_customer.php?id='.$row['id'].'" class="btn btn-sm btn-success">
                              <i class="fa fa-pen"></i>
                            </a>
                            <a href="delete_customer.php?id='.$row['id'].'" class="btn btn-sm btn-danger mx-1">
